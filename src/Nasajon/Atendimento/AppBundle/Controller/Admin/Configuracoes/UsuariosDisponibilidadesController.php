...
const ATENDIMENTO = 'ATENDIMENTO';
    ...
    /**
     *
     * @FOS\Get("/usuariosdisponibilidades/templates/index.html", defaults={ "_format" = "html" })
     */
    public function indexAction(Request $request) {
        return $this->render('@NasajonAtendimentoAppBundle/Resources/views/Admin/Configuracoes/index.html.twig');
    }
     ...
     *
     * @FOS\Get("/usuariosdisponibilidades/template/form.html", defaults={ "_format" = "html" })
     */
    ...
    /**
     * @FOS\Get("/usuariosdisponibilidades", defaults={ "_format" = "json" })
     */
    ...
    /**
     * @FOS\Put("/usuariosdisponibilidades", defaults={ "_format" = "json" })
     */
