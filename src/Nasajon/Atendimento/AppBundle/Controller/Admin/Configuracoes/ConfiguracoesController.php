...
use Nasajon\Atendimento\AppBundle\Form\Admin\Configuracoes\ConfiguracoesType;
...
class ConfiguracoesController extends Controller {
    ...
    public function createCreateForm() {
        return $this->get('form.factory')
                        ->createNamedBuilder(NULL, ConfiguracoesType::class, NULL, array(
                            'method' => "PUT"
                        ))
                        ->getForm();
    }
    ...
    /**
     * @FOS\Get("/configuracoes/index.html", defaults={ "_format" = "html" })
    ...
    public function templateAction(Request $request)
    {
        ...
        if (!$permissaoUsuarioService->verificaPermissaoAdmin()) {
            return $this->render('@NasajonAtendimentoAppBundle/Resources/views/Default/403.html.twig');
        }
        return $this->render('@NasajonAtendimentoApp/Admin/Configuracoes/list.html.twig');
    }
    ...
    public function templateFormAction(Request $request) {
        ...
        return $this->render('NasajonAtendimentoAppBundle:Admin/Configuracoes/Portal:configuracoes.html.twig', array(
                    'form' => $form->createView(),
        ));
    }

    /**
     * @FOS\Get("/configuracoes/gerais", defaults={ "_format" = "json" })
     * @FuncaoProvisao({"ADMIN", "USUARIO"})
     */
    ...
    /**
     * @FOS\Put("/configuracoes/gerais", defaults={ "_format" = "json" })
     * @FuncaoProvisao({"ADMIN"})
     */
    public function putAction(Request $request) {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            foreach ($form->getData() as $key => $value) {
                if (array_key_exists($key, $configuracoes) && 
