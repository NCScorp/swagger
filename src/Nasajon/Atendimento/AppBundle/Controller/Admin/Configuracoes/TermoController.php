...
use Nasajon\Atendimento\AppBundle\Form\Admin\Configuracoes\TermoType;
...
class TermoController extends Controller {
  ...
  public function createCreateForm() {
    return $this->get('form.factory')
                    ->createNamedBuilder(NULL, TermoType::class, NULL, array(
                        'method' => "PUT"
                    ))
                    ->getForm();
  }
   ...
   *
   * @FOS\Get("/configuracoes/template/termo.html", defaults={ "_format" = "html" })
   * @FuncaoProvisao({"ADMIN"})
   */
  public function templateFormAction(Request $request) {
    $form = $this->createCreateForm();
    return $this->render('NasajonAtendimentoAppBundle:Admin/Configuracoes/Termo:termo.html.twig', array(
                'form' => $form->createView(),
    ));
  }

  /**
   * @FOS\Get("/configuracoes/termo", defaults={ "_format" = "json" })
  ...
  /**
   * @FOS\Put("/configuracoes/termo", defaults={ "_format" = "json" })
   * @FuncaoProvisao({"ADMIN"})
   */
