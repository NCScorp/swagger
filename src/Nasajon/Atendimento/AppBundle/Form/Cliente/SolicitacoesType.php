...
use Nasajon\MDABundle\Form\Atendimento\Cliente\SolicitacoesType as SolicitacoesParentType;
...
class SolicitacoesType extends SolicitacoesParentType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder->add('camposcustomizados', SolicitacoesCamposcustomizadosType::class, array(
            'label' => false,
            'model' => 'tndmnt_clnt_slctcs_frm_cntrllr.entity.camposcustomizados',
    ...
    public function configureOptions(OptionsResolver $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'Nasajon\MDABundle\Entity\Atendimento\Cliente\Solicitacoes',
