...
use Nasajon\MDABundle\Entity\Crm\Atcsareas;
use Nasajon\AppBundle\Enum\EnumAcao;

/**
 * Crm\Atcsareas controller.
 */
class AtcsareasController extends \Nasajon\MDABundle\Controller\Crm\AtcsareasController
{

    /**
     * Sobrescrito para alterar o denyAccessUnlessGranted
     *
     * @FOS\Post("/atcsareas/", defaults={ "_format" = "json" })
     */
    public function createAction(Request $request)
    {
        try {
            ...
            $this->denyAccessUnlessGranted(EnumAcao::ATCSAREAS_CREATE);
     ...
     * Sobrescrito para alterar o denyAccessUnlessGranted
     *
     * @FOS\Put("/atcsareas/{id}", defaults={ "_format" = "json" })
     */
    public function putAction(Request $request, $id)
    {
        try {
            ...
            $this->denyAccessUnlessGranted(EnumAcao::ATCSAREAS_PUT);
            ...
            throw $this->createNotFoundException('Unable to find Crm\Atcsareas entity.');
    ...
    /**
     * Lists all CrmAtcsareas entities.
     *
     * @FOS\Get("/atcsareas/")
    ...
    public function indexAction(Filter $filter = null, Request $request)
    {
        try {
            ...
            $this->denyAccessUnlessGranted(EnumAcao::ATCSAREAS_INDEX);
