...
/**
 * Crm\Propostasitensfuncoes controller.
 */
class PropostasitensfuncoesController extends \Nasajon\MDABundle\Controller\Crm\PropostasitensfuncoesController
{

    /**
     * Creates a new Crm\Propostasitensfuncoes entity.
     *
     * @FOS\Post("/{propostaitem}/propostasitensfuncoes/", defaults={ "_format" = "json" })
     */
    public function createAction($propostaitem, Request $request)
    {
        try {
            ...
            $entity = new Propostasitensfuncoes();
            ...
            $this->denyAccessUnlessGranted(EnumAcao::PROPOSTASITENSFUNCOES_CREATE);
    ...
    /**
     * Edits an existing Crm\Propostasitensfuncoes entity.
     *
     * @FOS\Put("/{propostaitem}/propostasitensfuncoes/{id}", defaults={ "_format" = "json" })
     */
    public function putAction($propostaitem, Request $request, $id)
    {
        try {
            ...
            throw $this->createNotFoundException('Unable to find Crm\Propostasitensfuncoes entity.');
    ...
    /**
     * Deletes a Crm\Propostasitensfuncoes entity.
     *
     * @FOS\Delete("/{propostaitem}/propostasitensfuncoes/{id}", defaults={ "_format" = "json" })
     */
    public function deleteAction($propostaitem, Request $request, $id)
    {
        try {
            ...
            $this->getService()->delete($tenant, $id_grupoempresarial, $logged_user, $propostaitem, $entity);
