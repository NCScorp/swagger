...
use Nasajon\MDABundle\Entity\Crm\Tiposacionamentos;
use Nasajon\AppBundle\Enum\EnumAcao;

/**
 * Crm\Tiposacionamentos controller.
 */
class TiposacionamentosController extends \Nasajon\MDABundle\Controller\Crm\TiposacionamentosController
{

    /**
     * Sobrescrito para alterar o denyAccessUnlessGranted
     *
     * @FOS\Get("/tiposacionamentos/")
    ...
    public function indexAction(Filter $filter = null, Request $request)
    {
        try {
            ...
            $entity = new Tiposacionamentos();
            $this->denyAccessUnlessGranted(EnumAcao::TIPOSACIONAMENTOS_INDEX);
     ...
     * Sobrescrito para alterar o denyAccessUnlessGranted
     *
     * @FOS\Get("/tiposacionamentos/{id}", defaults={ "_format" = "json" })
     */
    public function getAction($id, Request $request)
    {
        try {
            ...
            $this->denyAccessUnlessGranted(EnumAcao::TIPOSACIONAMENTOS_GET);
     ...
     * Sobrescrito para alterar o denyAccessUnlessGranted
     *
     * @FOS\Post("/tiposacionamentos/", defaults={ "_format" = "json" })
     */
    public function createAction(Request $request)
    {
        try {
            ...
            $this->denyAccessUnlessGranted(EnumAcao::TIPOSACIONAMENTOS_CREATE);
     ...
     * Sobrescrito para alterar o denyAccessUnlessGranted
     *
     * @FOS\Put("/tiposacionamentos/{id}", defaults={ "_format" = "json" })
     */
    public function putAction(Request $request, $id)
    {
        try {
            ...
            $this->denyAccessUnlessGranted(EnumAcao::TIPOSACIONAMENTOS_PUT);
            ...
            throw $this->createNotFoundException('Unable to find Crm\Tiposacionamentos entity.');
     ...
     * Sobrescrito para alterar o denyAccessUnlessGranted
     *
     * @FOS\Delete("/tiposacionamentos/{id}", defaults={ "_format" = "json" })
     */
    public function deleteAction(Request $request, $id)
    {
        try {
            ...
            $this->denyAccessUnlessGranted(EnumAcao::TIPOSACIONAMENTOS_DELETE);
