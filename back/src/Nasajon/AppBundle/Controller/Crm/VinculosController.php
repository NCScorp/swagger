...
use Nasajon\MDABundle\Entity\Crm\Vinculos;
use Nasajon\AppBundle\Enum\EnumAcao;

/**
 * Crm\Vinculos controller.
 */
class VinculosController extends \Nasajon\MDABundle\Controller\Crm\VinculosController
{

    /**
     * Sobrescrito para alterar o denyAccessUnlessGranted
     *
     * @FOS\Post("/vinculos/", defaults={ "_format" = "json" })
     */
    public function createAction(Request $request)
    {
        try {
            ...
            $this->denyAccessUnlessGranted(EnumAcao::VINCULOS_CREATE);
     ...
     * Sobrescrito para alterar o denyAccessUnlessGranted
     *
     * @FOS\Put("/vinculos/{id}", defaults={ "_format" = "json" })
     */
    public function putAction(Request $request, $id)
    {
        try {
            ...
            $this->denyAccessUnlessGranted(EnumAcao::VINCULOS_PUT);
            ...
            throw $this->createNotFoundException('Unable to find Crm\Vinculos entity.');
    ...
    /**
     * Lists all CrmVinculos entities.
     *
     * @FOS\Get("/vinculos/")
    ...
    public function indexAction(Filter $filter = null, Request $request)
    {
        try {
            ...
            $this->denyAccessUnlessGranted(EnumAcao::VINCULOS_INDEX);
