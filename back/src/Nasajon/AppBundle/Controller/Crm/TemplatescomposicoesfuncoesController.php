...
use Nasajon\MDABundle\Entity\Crm\Templatescomposicoesfuncoes;
use Nasajon\MDABundle\Controller\Crm\TemplatescomposicoesfuncoesController as ParentController;

/**
 * Crm\Templatescomposicoesfuncoes controller.
 */
class TemplatescomposicoesfuncoesController extends ParentController
{

   
    /**
     * Deletes a Crm\Templatescomposicoesfuncoes entity.
     *
     * @FOS\Delete("/{templatepropostacomposicao}/templatescomposicoesfuncoes/{id}", defaults={ "_format" = "json" })
          */
    public function deleteAction($templatepropostacomposicao, Request $request, $id)
    {
        try{
            ...
            throw $this->createNotFoundException('Unable to find Crm\Templatescomposicoesfuncoes entity.');
