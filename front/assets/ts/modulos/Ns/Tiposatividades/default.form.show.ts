...
export class NsTiposatividadesDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'NsTiposatividades', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.tipoatividade = response.data.tipoatividade;
                    resolve(this.entity);
                })
                .catch((response: any) => {
