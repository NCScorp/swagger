...
export class NsPessoastiposatividadesDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'NsPessoastiposatividades', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.pessoatipoatividade = response.data.pessoatipoatividade;
                    resolve(this.entity);
                })
                .catch((response: any) => {
