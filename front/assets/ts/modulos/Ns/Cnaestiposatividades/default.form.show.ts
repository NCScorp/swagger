...
export class NsCnaestiposatividadesDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'NsCnaestiposatividades', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.cnaetipoatividade = response.data.cnaetipoatividade;
                    resolve(this.entity);
                })
                .catch((response: any) => {
