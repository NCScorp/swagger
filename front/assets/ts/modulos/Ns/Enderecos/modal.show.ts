...
export class NsEnderecosFormModalShowController {
...
export class NsEnderecosFormShowService {
    ...
    open(parameters: any, subentity: any) {
            return this.$uibModal.open({
                ...
                controller: 'NsEnderecosFormModalShowController',
                controllerAs: 'ns_ndrcs_frm_shw_cntrllr',
                windowClass: '',
                resolve: {
                entity: () => {
