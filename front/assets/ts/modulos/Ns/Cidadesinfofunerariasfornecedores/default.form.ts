...
export class NsCidadesinfofunerariasfornecedoresDefaultController {

    static $inject = [ '$scope', 'toaster', 'NsCidadesinfofunerariasfornecedores', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.cidadeinfofunerariafornecedor = response.data.cidadeinfofunerariafornecedor;
                    resolve(this.entity);
                })
                .catch((response: any) => {
