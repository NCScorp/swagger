...
export class NsTiposdocumentosListController {
    static $inject = [
        'utilService',
        '$scope',
        '$stateParams',
    ...
    constructor(
        public utilService: any, public $scope: any,
        public $stateParams: any, public $state: any,
        public entityService: any, public toaster: any,
        ...
        for (let i in $stateParams) {
            ...
            } else if (typeof $stateParams[i] !== 'undefined' && typeof $stateParams[i] !== 'function' && i !== 'q' && i !== 'tipodocumento') {
        ...
        this.fields = $rootScope.FIELDS_NsTiposdocumentos;
        $scope.$on('ns_tiposdocumentos_deleted', (event: any) => {
        ...
        $rootScope.$on('ns_tiposdocumentos_submitted', (event: any, args: any) => {
            if (!args.autosave) {
                this.entityService.reload();
            }
        });
