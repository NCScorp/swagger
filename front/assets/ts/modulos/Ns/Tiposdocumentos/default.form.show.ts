...
export class NsTiposdocumentosDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'NsTiposdocumentos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.tipodocumento = response.data.tipodocumento;
                    resolve(this.entity);
                })
                .catch((response: any) => {
