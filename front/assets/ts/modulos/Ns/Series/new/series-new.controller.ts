...
export class NsSeriesNewController {
    static $inject = [
        'utilService',
        '$scope',
        '$stateParams',
    ...
    constructor(
        ...
        $scope.$on('ns_series_submitted', (event: any, args: any) => {
            this.toaster.pop({
                type: 'success',
                title: 'Sucesso ao incluir Série!'
            });
            ...
            if (args.response.status === 409) {
                ...
                if (typeof (args.response.data.message) !== 'undefined' && args.response.data.message) {
                    ...
                    this.toaster.pop(
                        {
                            type: 'error',
                            title: 'Ocorreu um erro ao inserir Ns\Series!'
                        });
                }
            }
    ...
    validaDados() {
        ...
        if (this.entity.proximo > this.entity.fim || this.entity.proximo < this.entity.inicio) {
            this.form.$valid = false;
            this.msgErro = 'Próximo deve ser um valor entre início e fim.';
            return;
        }
    }
