...
export class NsSeriesShowFormController {

    static $inject = ['$scope', 'toaster', 'nsSeriesService', 'utilService'];
    ...
    submit() {
        ...
        if (this.form.$valid && !this.entity.$$__submitting) {
            return new Promise((resolve) => {
                this.nsSeriesService._save(this.entity).then((response: any) => {
                    this.entity.serie = response.data.serie;
                    resolve(this.entity);
                })
                    .catch((response: any) => {
