...
export class NsPrioridadesFormNewController {

    static $inject = ['utilService', '$scope', '$stateParams', '$state', 'NsPrioridades', 'toaster', 'entity'];
    ...
    constructor(
        ...
        $scope.$on('ns_prioridades_submitted', (event: any, args: any) => {
            this.toaster.pop({
                type: 'success',
                title: 'A Prioridade foi criada com sucesso!'
            });
            ...
            if (args.response.status === 409) {
                ...
                if (typeof (args.response.data.message) !== 'undefined' && args.response.data.message) {
                    ...
                    this.toaster.pop(
                        {
                            type: 'error',
                            title: 'Ocorreu um erro ao criar a Prioridade!'
                        });
                }
            }
