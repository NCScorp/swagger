...
export class NsPrioridadesDefaultShowController {
    ...
    $onInit() {
        ...
        // Para exibir com a palavra 'minutos' depois do número de minutos do prazo e notificar expiração, caso possua valores válidos nos campos
        if (this.entity.prazoexpiracao != null && this.entity.notificarexpiracaofaltando != null){
            this.entity.prazoexpiracao = this.entity.prazoexpiracao + ' minutos';
            this.entity.notificarexpiracaofaltando = this.entity.notificarexpiracaofaltando + ' minutos';
        }
