...
export class NsFornecedoresFormNewController {
    static $inject = [                                                                                                                                                                        'utilService', '$scope', '$stateParams', '$state', 'NsFornecedores', 'toaster'
    , 'entity' ];
    ...
    , public entity: any ) {
                this.constructors = entityService.constructors;
                        $scope.$on('ns_fornecedores_submitted', (event: any, args: any) => {
                            this.toaster.pop({
                    type: 'success',
                    title: 'A Prestadora de Serviços foi criada com sucesso!'
                });
       ...
       if (typeof (args.response.data.message) !== 'undefined' && args.response.data.message) {
            ...
            {
                type: 'error',
                title: 'Ocorreu um erro ao criar a Prestadora de Serviços!'            });
        }
    }
