...
export class NsFornecedoresFormFornecedorreativarController {
    ...
    submit() {
        if (this.form.$valid) {
               ...
               .then((response: any) => {
                                                 this.toaster.pop({
                           type: 'success',
                           title : 'A suspensão da Prestadora de Serviços foi removida com sucesso!'
                       });
       ...
       if (typeof (response.data.message) !== 'undefined' && response.data.message) {
            ...
            {
                type: 'error',
                title: 'Ocorreu um erro ao remover a suspensão da Prestadora de Serviços!'            });
        }
    }
...
export class NsFornecedoresFormFornecedorreativarService {
    ...
    open(ctrlEntity: any) {
            return this.$uibModal.open({
                ...
                controller: 'NsFornecedoresFormFornecedorreativarController',
                controllerAs: 'ns_frncdrs_frm_frncdrrtvr_cntrllr',
                windowClass: '',
                resolve: {
                    entity: () => {
                        return ctrlEntity;
