...
export class NsFornecedoresdocumentosDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'NsFornecedoresdocumentos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.fornecedordocumento = response.data.fornecedordocumento;
                    resolve(this.entity);
                })
                .catch((response: any) => {
