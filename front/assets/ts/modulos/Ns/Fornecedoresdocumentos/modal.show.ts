...
export class NsFornecedoresdocumentosFormModalShowController {
...
export class NsFornecedoresdocumentosFormShowService {
    static $inject = ['NsFornecedoresdocumentos', '$uibModal'];
    ...
    open(parameters: any, subentity: any) {
            return this.$uibModal.open({
                ...
                controller: 'NsFornecedoresdocumentosFormModalShowController',
                controllerAs: 'ns_frncdrsdcmnts_frm_dflt_cntrllr',
                windowClass: '',
                resolve: {
                entity: () => {
