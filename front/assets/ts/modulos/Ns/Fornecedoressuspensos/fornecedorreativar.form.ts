...
export class NsFornecedoressuspensosFornecedorreativarController {
    ...
    $onInit() {
                        if ( typeof this.entity.motivoremocaosuspensao === 'undefined' ) {
            this.entity.motivoremocaosuspensao = '';
        }
