...
export class NsClientesFormController {
    static $inject = [
    'utilService',
    '$scope',
    '$stateParams',
    ...
    constructor(public utilService: any, public $scope: any, public $stateParams: any, public $state: any, public entityService: any, public toaster: any
        , public entity: any) {
        this.action = entity.cliente ? 'update' : 'insert'; $scope.$watch('ns_clnts_frm_cntrllr.entity', (newValue: any, oldValue: any) => {
        ...
        $scope.$on('ns_clientes_submitted', (event: any, args: any) => {
            let insertSuccess = 'O Cliente foi criado com sucesso!';
            let updateSuccess = 'O Cliente foi editado com sucesso!';
            ...
            if (args.response.status === 409) {
                ...
                if (typeof (args.response.data.message) !== 'undefined' && args.response.data.message) {
                    ...
                    this.toaster.pop(
                        {
                            type: 'error',
                            title: args.response.config.method === 'PUT' ? 'Ocorreu um erro ao editar o Cliente!' : 'Ocorreu um erro ao criar o Cliente!'
                        });
                }
            }
        ...
        this.entity.diasparavencimento = parseInt(this.entity.diasparavencimento);
        {
