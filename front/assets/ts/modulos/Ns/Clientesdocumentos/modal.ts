...
export class NsClientesdocumentosFormModalController {
    ...
    public submitted: boolean = false;
        ...
        this.action = entity.clientedocumento ? 'update' : 'insert';
    }
        submit() {
        this.submitted = true;
        if (this.form.$valid) {
...
export class NsClientesdocumentosFormService {
    ...
    open(parameters: any, subentity: any) {
            return this.$uibModal.open({
                ...
                controller: 'NsClientesdocumentosFormModalController',
