...
export class CrmSegmentosatuacaoDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmSegmentosatuacao', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.segmentoatuacao = response.data.segmentoatuacao;
                    resolve(this.entity);
                })
                .catch((response: any) => {
