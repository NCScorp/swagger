...
export class CrmPromocoesleadsDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmPromocoesleads', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.promocaolead = response.data.promocaolead;
                    resolve(this.entity);
                })
                .catch((response: any) => {
