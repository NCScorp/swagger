...
export class CrmHistoricospadraoDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmHistoricospadrao', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.historicopadrao = response.data.historicopadrao;
                    resolve(this.entity);
                })
                .catch((response: any) => {
