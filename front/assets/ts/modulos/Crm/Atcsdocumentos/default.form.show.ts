...
export class CrmAtcsdocumentosDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmAtcsdocumentos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.negociodocumento = response.data.negociodocumento;
                    resolve(this.entity);
                })
                .catch((response: any) => {
