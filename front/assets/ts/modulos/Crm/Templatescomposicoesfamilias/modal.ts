...
export class CrmTemplatescomposicoesfamiliasFormModalController {
    ...
    public submitted: boolean = false;
        ...
        this.action = entity.templatecomposicaofamilia ? 'update' : 'insert';
    }
        submit() {
        this.submitted = true;
        if (this.form.$valid) {
...
export class CrmTemplatescomposicoesfamiliasFormService {
    static $inject = ['CrmTemplatescomposicoesfamilias', '$uibModal'];
    ...
    open(parameters: any, subentity: any) {
            return this.$uibModal.open({
                ...
                controller: 'CrmTemplatescomposicoesfamiliasFormModalController',
                controllerAs: 'crm_tmpltscmpscsfmls_frm_dflt_cntrllr',
                windowClass: '',
                resolve: {
                entity: () => {
