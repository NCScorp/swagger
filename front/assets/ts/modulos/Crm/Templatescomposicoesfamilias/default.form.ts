...
export class CrmTemplatescomposicoesfamiliasDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmTemplatescomposicoesfamilias', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.templatecomposicaofamilia = response.data.templatecomposicaofamilia;
                    resolve(this.entity);
                })
                .catch((response: any) => {
