...
export class CrmPropostascapitulosDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmPropostascapitulos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.propostacapitulo = response.data.propostacapitulo;
                    resolve(this.entity);
                })
                .catch((response: any) => {
