...
export class CrmAtcclientefornecedorescontatosListController {
    static $inject = ['utilService', '$scope', '$stateParams', '$state', 'CrmAtcclientefornecedorescontatos', 'toaster'
        ,
    ...
    constructor(public utilService: any, public $scope: any, public $stateParams: any, public $state: any, public entityService: any, public toaster: any
        ...
        for (let i in $stateParams) {
            ...
            } else if (typeof $stateParams[i] !== 'undefined' && typeof $stateParams[i] !== 'function' && i !== 'q' && i !== 'contato') {
        ...
        this.fields = $rootScope.FIELDS_CrmAtcclientefornecedorescontatos;
        $scope.$on('crm_atcclientefornecedorescontatos_deleted', (event: any) => {
        ...
        $rootScope.$on('crm_atcclientefornecedorescontatos_submitted', (event: any, args: any) => {
            if (!args.autosave) {
                this.entityService.reload();
            }
        });
