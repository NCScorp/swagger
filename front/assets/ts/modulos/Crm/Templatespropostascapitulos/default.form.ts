...
export class CrmTemplatespropostascapitulosDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmTemplatespropostascapitulos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.templatepropostacapitulo = response.data.templatepropostacapitulo;
                    resolve(this.entity);
                })
                .catch((response: any) => {
