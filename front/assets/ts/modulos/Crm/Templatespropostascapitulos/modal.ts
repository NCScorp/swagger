...
export class CrmTemplatespropostascapitulosFormModalController {
    ...
    public submitted: boolean = false;
        ...
        this.action = entity.templatepropostacapitulo ? 'update' : 'insert';
    }
        submit() {
        this.submitted = true;
        if (this.form.$valid) {
...
export class CrmTemplatespropostascapitulosFormService {
    static $inject = ['CrmTemplatespropostascapitulos', '$uibModal'];
    ...
    open(parameters: any, subentity: any) {
            return this.$uibModal.open({
                ...
                controller: 'CrmTemplatespropostascapitulosFormModalController',
                controllerAs: 'crm_tmpltsprpstscptls_frm_dflt_cntrllr',
                windowClass: '',
                resolve: {
                entity: () => {
