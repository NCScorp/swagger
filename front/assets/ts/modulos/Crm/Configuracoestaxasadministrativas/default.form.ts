...
export class CrmConfiguracoestaxasadministrativasDefaultController {

    static $inject = ['$scope', 'toaster', 'CrmConfiguracoestaxasadministrativas', 'utilService'];
    ...
    defineConstrutorPessoaMunicipio(){
        ...
        if (this.form.$valid && !this.entity.$$__submitting) {
            return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.configuracaotaxaadm = response.data.configuracaotaxaadm;
                    resolve(this.entity);
                })
                    .catch((response: any) => {
