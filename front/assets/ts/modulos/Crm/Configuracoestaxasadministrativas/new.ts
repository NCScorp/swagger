...
export class CrmConfiguracoestaxasadministrativasFormNewController {
    ...
    constructor(public utilService: any, public $scope: any, public $stateParams: any, public $state: any, public entityService: any, public toaster: any
        ...
        $scope.$on('crm_configuracoestaxasadministrativas_submitted', (event: any, args: any) => {
            this.toaster.pop({
                type: 'success',
                title: 'A Configuração de Taxa Administrativa foi criada com sucesso!'
            });
            ...
            if (args.response.status === 409) {
                ...
                if (typeof (args.response.data.message) !== 'undefined' && args.response.data.message) {
                    ...
                    this.toaster.pop(
                        {
                            type: 'error',
                            title: 'Ocorreu um erro ao criar a Configuração de Taxa Administrativa!'
                        });
                }
            }
