...
export class CrmAtcspendenciaslistasDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmAtcspendenciaslistas', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.negociopendencialista = response.data.negociopendencialista;
                    resolve(this.entity);
                })
                .catch((response: any) => {
