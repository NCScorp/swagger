...
export class CrmPropostasitensfuncoesDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmPropostasitensfuncoes', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.propostaitemfuncao = response.data.propostaitemfuncao;
                    resolve(this.entity);
                })
                .catch((response: any) => {
