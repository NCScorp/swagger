...
export class CrmAtcsconfiguracoesdocumentositensDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmAtcsconfiguracoesdocumentositens', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.atcconfiguracaodocumentoitem = response.data.atcconfiguracaodocumentoitem;
                    resolve(this.entity);
                })
                .catch((response: any) => {
