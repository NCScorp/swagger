...
export class CrmAtcsconfiguracoesdocumentositensFormNewController {
    ...
    , public entity: any ) {
            ...
            if ( this.entityService.loading_deferred ) {
                ...
                $scope.$on('crm_atcsconfiguracoesdocumentositens_submitted', (event: any, args: any) => {
                            this.toaster.pop({
                    type: 'success',
                    title: 'A Configuração do Item do Documento foi criada com sucesso!'
                });
       ...
       if (typeof (args.response.data.message) !== 'undefined' && args.response.data.message) {
            ...
            {
                type: 'error',
                title: 'Ocorreu um erro ao criar a Configuração do Item do Documento!'            });
        }
    }
