...
export class CrmListadavezvendedoresitensDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmListadavezvendedoresitens', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.listadavezvendedoritem = response.data.listadavezvendedoritem;
                    resolve(this.entity);
                })
                .catch((response: any) => {
