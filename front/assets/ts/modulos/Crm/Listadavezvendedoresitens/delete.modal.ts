...
export class CrmListadavezvendedoresitensFormDefaultController {
    static $inject = ['CrmListadavezvendedoresitens', 'toaster', 'utilService',  '$uibModalInstance', 'entity'];
...
export class CrmListadavezvendedoresitensFormDefaultService {
    ...
    open(ctrlEntity: any) {
            return this.$uibModal.open({
                ...
                controller: 'CrmListadavezvendedoresitensFormDefaultController',
                controllerAs: 'crm_lstdvzvnddrstns_frm_dflt_cntrllr',
                windowClass: '',
                resolve: {
                    entity: () => {
                        return ctrlEntity;
