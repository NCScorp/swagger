...
export class CrmAtcstiposdocumentosrequisitantesDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmAtcstiposdocumentosrequisitantes', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.negociotipodocumentorequisitante = response.data.negociotipodocumentorequisitante;
                    resolve(this.entity);
                })
                .catch((response: any) => {
