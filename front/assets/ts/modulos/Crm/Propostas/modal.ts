...
export class CrmPropostasFormModalController {
    ...
    public submitted: boolean = false;
        ...
        this.action = entity.proposta ? 'update' : 'insert';
    }
        submit() {
        this.submitted = true;
        if (this.form.$valid) {
...
export class CrmPropostasFormService {
    ...
    open(parameters: any, subentity: any) {
            return this.$uibModal.open({
                ...
                controller: 'CrmPropostasFormModalController',
