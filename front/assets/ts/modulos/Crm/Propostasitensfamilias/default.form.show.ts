...
export class CrmPropostasitensfamiliasDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmPropostasitensfamilias', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.propostaitemfamilia = response.data.propostaitemfamilia;
                    resolve(this.entity);
                })
                .catch((response: any) => {
