...
import { EnumNegocioContatoCargo } from '../Negocios/classes';
export class CrmNegocioscontatosDefaultController {

    static $inject = ['$scope', 'toaster', 'CrmNegocioscontatos', 'utilService'];
    ...
    /**
     * Enum referente aos tipos de cargo do contato
     */
    private EnumNegocioContatoCargo = EnumNegocioContatoCargo;
