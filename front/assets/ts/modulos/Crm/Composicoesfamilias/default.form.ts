...
export class CrmComposicoesfamiliasDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmComposicoesfamilias', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.composicaofamilia = response.data.composicaofamilia;
                    resolve(this.entity);
                })
                .catch((response: any) => {
