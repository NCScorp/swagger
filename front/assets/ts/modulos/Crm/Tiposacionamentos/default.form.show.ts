...
export class CrmTiposacionamentosDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmTiposacionamentos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.tiposacionamento = response.data.tiposacionamento;
                    resolve(this.entity);
                })
                .catch((response: any) => {
