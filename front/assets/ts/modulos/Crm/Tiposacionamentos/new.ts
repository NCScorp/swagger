...
export class CrmTiposacionamentosFormNewController {
    ...
    , public entity: any ) {
                this.constructors = entityService.constructors;
                        $scope.$on('crm_tiposacionamentos_submitted', (event: any, args: any) => {
                            this.toaster.pop({
                    type: 'success',
                    title: 'O Tipo de Acionamento foi criado com sucesso!'
                });
       ...
       if (typeof (args.response.data.message) !== 'undefined' && args.response.data.message) {
            ...
            {
                type: 'error',
                title: 'Ocorreu um erro ao criar o Tipo de Acionamento!'            });
        }
    }
