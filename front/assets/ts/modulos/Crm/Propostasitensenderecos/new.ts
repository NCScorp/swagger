...
export class CrmPropostasitensenderecosFormNewController {
    ...
    , public entity: any ) {
                this.constructors = entityService.constructors;
                        $scope.$on('crm_propostasitensenderecos_submitted', (event: any, args: any) => {
                            this.toaster.pop({
                    type: 'success',
                    title: 'Sucesso ao inserir Crm\Propostasitensenderecos!'
                });
       ...
       if (typeof (args.response.data.message) !== 'undefined' && args.response.data.message) {
            ...
            {
                type: 'error',
                title: 'Ocorreu um erro ao inserir Crm\Propostasitensenderecos!'            });
        }
    }
