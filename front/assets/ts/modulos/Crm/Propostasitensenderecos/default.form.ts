...
export class CrmPropostasitensenderecosDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmPropostasitensenderecos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.propostaitemendereco = response.data.propostaitemendereco;
                    resolve(this.entity);
                })
                .catch((response: any) => {
