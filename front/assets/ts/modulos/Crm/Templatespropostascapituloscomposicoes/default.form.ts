...
export class CrmTemplatespropostascapituloscomposicoesDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmTemplatespropostascapituloscomposicoes', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.templatepropostacomposicao = response.data.templatepropostacomposicao;
                    resolve(this.entity);
                })
                .catch((response: any) => {
