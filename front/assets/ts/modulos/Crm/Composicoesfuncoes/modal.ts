...
export class CrmComposicoesfuncoesFormModalController {
    ...
    constructor(public toaster: any, public $uibModalInstance: any, public entity: any, public constructors: any) {
        this.action = entity.composicaofuncao ? 'update' : 'insert';
    }
...
export class CrmComposicoesfuncoesFormService {
    static $inject = ['CrmComposicoesfuncoes', '$uibModal'];
    ...
    open(parameters: any, subentity: any) {
            return this.$uibModal.open({
                ...
                controller: 'CrmComposicoesfuncoesFormModalController',
                controllerAs: 'crm_cmpscsfncs_frm_dflt_cntrllr',
                windowClass: '',
                resolve: {
                entity: () => {
