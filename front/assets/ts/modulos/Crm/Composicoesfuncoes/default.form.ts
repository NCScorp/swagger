...
export class CrmComposicoesfuncoesDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmComposicoesfuncoes', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.composicaofuncao = response.data.composicaofuncao;
                    resolve(this.entity);
                })
                .catch((response: any) => {
