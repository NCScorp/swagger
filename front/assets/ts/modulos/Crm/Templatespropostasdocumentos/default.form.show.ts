...
export class CrmTemplatespropostasdocumentosDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmTemplatespropostasdocumentos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.templatepropostadocumento = response.data.templatepropostadocumento;
                    resolve(this.entity);
                })
                .catch((response: any) => {
