...
export class CrmAtcsVisualizacaoShowController {
    ...
    constructor(public CrmAtcsresponsaveisfinanceirosFormService: any,
        ...
        public $scope: any, public toaster: any, public entityService: any, public utilService: any) {
    ...
    crmAtcstiposdocumentosrequisitantesFormEdit(subentity: any) {
        let parameter = { 'atc': subentity.negocio, 'identifier': subentity.negociotipodocumentorequisitante };
