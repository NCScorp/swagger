...
export class CrmAtcsfollowupsanexosDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmAtcsfollowupsanexos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.negociofollowupanexo = response.data.negociofollowupanexo;
                    resolve(this.entity);
                })
                .catch((response: any) => {
