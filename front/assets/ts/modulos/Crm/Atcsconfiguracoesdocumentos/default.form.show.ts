...
export class CrmAtcsconfiguracoesdocumentosDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmAtcsconfiguracoesdocumentos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.atcconfiguracaodocumento = response.data.atcconfiguracaodocumento;
                    resolve(this.entity);
                })
                .catch((response: any) => {
