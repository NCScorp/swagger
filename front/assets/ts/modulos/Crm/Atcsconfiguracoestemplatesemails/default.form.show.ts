...
export class CrmAtcsconfiguracoestemplatesemailsDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmAtcsconfiguracoestemplatesemails', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.atcconfiguracaotemplateemail = response.data.atcconfiguracaotemplateemail;
                    resolve(this.entity);
                })
                .catch((response: any) => {
