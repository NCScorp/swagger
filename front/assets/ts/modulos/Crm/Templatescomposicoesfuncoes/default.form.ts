...
export class CrmTemplatescomposicoesfuncoesDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmTemplatescomposicoesfuncoes', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.templatecomposicaofuncao = response.data.templatecomposicaofuncao;
                    resolve(this.entity);
                })
                .catch((response: any) => {
