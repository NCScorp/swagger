...
export class CrmResponsabilidadesfinanceirasvaloresDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmResponsabilidadesfinanceirasvalores', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.responsabilidadefinanceiravalor = response.data.responsabilidadefinanceiravalor;
                    resolve(this.entity);
                })
                .catch((response: any) => {
