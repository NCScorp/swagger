...
export class CrmResponsabilidadesfinanceirasvaloresFormNewController {
    ...
    , public entity: any ) {
        ...
        for (var i in $stateParams) {
            ...
            if ( this.entityService.loading_deferred ) {
                ...
                $scope.$on('crm_responsabilidadesfinanceirasvalores_submitted', (event: any, args: any) => {
                            this.toaster.pop({
                    type: 'success',
                    title: 'Sucesso ao inserir Crm\Responsabilidadesfinanceirasvalores!'
                });
       ...
       if (typeof (args.response.data.message) !== 'undefined' && args.response.data.message) {
            ...
            {
                type: 'error',
                title: 'Ocorreu um erro ao inserir Crm\Responsabilidadesfinanceirasvalores!'            });
        }
    }
