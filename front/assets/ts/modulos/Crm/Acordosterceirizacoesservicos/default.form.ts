...
export class CrmAcordosterceirizacoesservicosDefaultController {

    static $inject = ['$scope', 'toaster', 'CrmAcordosterceirizacoesservicos', 'utilService'];
        ...
        if (this.form.$valid && !this.entity.$$__submitting) {
            return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.acordoterceirizacaoservico = response.data.acordoterceirizacaoservico;
                    resolve(this.entity);
                })
                    .catch((response: any) => {
