...
export class ModalExclusaoAcordoTerceirizacaoServController {
...
export class ModalExclusaoAcordoTerceirizacaoServService {
    ...
    open(parameters: any) {
        return this.$uibModal.open({
            ...
            controller: 'ModalExclusaoAcordoTerceirizacaoServController',
