...
export class CrmAtcsareaspendenciasDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmAtcsareaspendencias', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.negocioareapendencia = response.data.negocioareapendencia;
                    resolve(this.entity);
                })
                .catch((response: any) => {
