...
export class CrmFornecedoresenvolvidosanexosDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmFornecedoresenvolvidosanexos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.fornecedorenvolvidoanexo = response.data.fornecedorenvolvidoanexo;
                    resolve(this.entity);
                })
                .catch((response: any) => {
