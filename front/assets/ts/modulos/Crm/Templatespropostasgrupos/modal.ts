...
export class CrmTemplatespropostasgruposFormModalController {
    ...
    public submitted: boolean = false;
        ...
        this.action = entity.templatepropostagrupo ? 'update' : 'insert';
    }
        submit() {
        this.submitted = true;
        if (this.form.$valid) {
...
export class CrmTemplatespropostasgruposFormService {
    static $inject = ['CrmTemplatespropostasgrupos', '$uibModal'];
    ...
    open(parameters: any, subentity: any) {
            return this.$uibModal.open({
                ...
                controller: 'CrmTemplatespropostasgruposFormModalController',
                controllerAs: 'crm_tmpltsprpstsgrps_frm_dflt_cntrllr',
                windowClass: '',
                resolve: {
                entity: () => {
