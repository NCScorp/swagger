...
export class CrmTemplatespropostasgruposDefaultController {

    static $inject = [ '$scope', 'toaster', 'CrmTemplatespropostasgrupos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.templatepropostagrupo = response.data.templatepropostagrupo;
                    resolve(this.entity);
                })
                .catch((response: any) => {
