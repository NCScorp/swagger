...
export class CrmNegociosFormDefaultController {
    ...
    submit() {
        if (this.form.$valid) {
               ...
               .then((response: any) => {
                                                 this.toaster.pop({
                           type: 'success',
                           title : 'O Negócio foi Excluído com sucesso!delete.'
                       });
       ...
       if (typeof (response.data.message) !== 'undefined' && response.data.message) {
            ...
            {
                type: 'error',
                title: 'Ocorreu um erro ao excluir o Negócio!delete.'            });
        }
    }
...
export class CrmNegociosFormDefaultService {
    ...
    open(ctrlEntity: any) {
            return this.$uibModal.open({
                ...
                controller: 'CrmNegociosFormDefaultController',
                controllerAs: 'crm_ngcs_frm_dflt_cntrllr',
                windowClass: '',
                resolve: {
                    entity: () => {
                        return ctrlEntity;
