...
export class CrmMalotesdocumentosDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmMalotesdocumentos', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.malotedocumento = response.data.malotedocumento;
                    resolve(this.entity);
                })
                .catch((response: any) => {
