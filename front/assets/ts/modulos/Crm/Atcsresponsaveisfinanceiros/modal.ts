...
export class CrmAtcsresponsaveisfinanceirosFormModalController {
    ...
    public submitted: boolean = false;
        ...
        this.action = entity.negocioresponsavelfinanceiro ? 'update' : 'insert';
    }
        submit() {
        this.submitted = true;
        if (this.form.$valid) {
...
export class CrmAtcsresponsaveisfinanceirosFormService {
    static $inject = ['CrmAtcsresponsaveisfinanceiros', '$uibModal'];
    ...
    open(parameters: any, subentity: any) {
            return this.$uibModal.open({
                ...
                controller: 'CrmAtcsresponsaveisfinanceirosFormModalController',
                controllerAs: 'crm_tcsrspnsvsfnncrs_frm_dflt_cntrllr',
                windowClass: '',
                resolve: {
                entity: () => {
