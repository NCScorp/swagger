...
export class CrmTemplatesemailadvertirprestadorDefaultShowController {

    static $inject = [ '$scope', 'toaster', 'CrmTemplatesemailadvertirprestador', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.templateemailadvertirprestador = response.data.templateemailadvertirprestador;
                    resolve(this.entity);
                })
                .catch((response: any) => {
