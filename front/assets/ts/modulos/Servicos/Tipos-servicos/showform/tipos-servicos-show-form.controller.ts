...
export class TiposServicosShowFormController {

    static $inject = ['$scope', 'toaster', 'tiposServicosService', 'utilService'];
    ...
    submit() {
        ...
        if (this.form.$valid && !this.entity.$$__submitting) {
            return new Promise((resolve) => {
                this.tiposServicosService._save(this.entity).then((response: any) => {
                    this.entity.tiposervico = response.data.tiposervico;
                    resolve(this.entity);
                })
                    .catch((response: any) => {
