...
export class TiposManutencoesShowFormController {

    static $inject = ['$scope', 'toaster', 'tiposManutencoesService', 'utilService'];
    ...
    submit() {
        ...
        if (this.form.$valid && !this.entity.$$__submitting) {
            return new Promise((resolve) => {
                this.tiposManutencoesService._save(this.entity).then((response: any) => {
                    this.entity.tipomanutencao = response.data.tipomanutencao;
                    resolve(this.entity);
                })
                    .catch((response: any) => {
