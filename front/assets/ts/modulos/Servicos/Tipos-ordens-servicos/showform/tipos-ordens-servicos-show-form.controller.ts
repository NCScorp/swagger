...
export class TiposOrdensServicosShowFormController {

    static $inject = ['$scope', 'toaster', 'tiposOrdensServicosService', 'utilService'];
    ...
    submit() {
        ...
        if (this.form.$valid && !this.entity.$$__submitting) {
            return new Promise((resolve) => {
                this.tiposOrdensServicosService._save(this.entity).then((response: any) => {
                    this.entity.tipoordemservico = response.data.tipoordemservico;
                    resolve(this.entity);
                })
                    .catch((response: any) => {
