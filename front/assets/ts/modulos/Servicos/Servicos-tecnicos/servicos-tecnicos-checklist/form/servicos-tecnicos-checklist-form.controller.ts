...
export class ServicosTecnicosChecklistFormController {
    ...
    submit() {
        ...
        if (this.form.$valid && !this.entity.$$__submitting) {
            return new Promise((resolve) => {
                this.servicosTecnicosChecklistService._save(this.entity).then((response: any) => {
                    this.entity.servicotecnicochecklist = response.data.servicotecnicochecklist;
                    resolve(this.entity);
                })
                    .catch((response: any) => {
