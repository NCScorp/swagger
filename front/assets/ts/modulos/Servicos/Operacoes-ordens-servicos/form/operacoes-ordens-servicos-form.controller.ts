...
export class OperacoesOrdensServicosFormController {

    static $inject = ['$scope', 'toaster', 'operacoesOrdensServicosService', 'utilService'];
    ...
    constructor(
        ...
        this.$scope.$watch('$ctrl.entity.utilizatipomanutencao', (utilizatipomanutencao) => {
            if (!utilizatipomanutencao) {
                this.entity.tipomanutencao = null
            }
        })
    }
    ...
    submit() {
        ...
        if (this.form.$valid && !this.entity.$$__submitting) {
            return new Promise((resolve) => {
                this.operacoesOrdensServicosService._save(this.entity).then((response: any) => {
                    this.entity.operacaoordemservico = response.data.operacaoordemservico;
                    resolve(this.entity);
                })
                    .catch((response: any) => {
