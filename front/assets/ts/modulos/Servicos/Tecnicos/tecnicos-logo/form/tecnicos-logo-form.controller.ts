...
export class TecnicosLogoFormController {

    static $inject = ['$scope', 'toaster', 'tecnicosLogoService', 'utilService'];
    ...
    submit() {
        ...
        if (this.form.$valid && !this.entity.$$__submitting) {
            return new Promise((resolve) => {
                this.tecnicosLogoService._save(this.entity,false).then((response: any) => {
                    this.entity.tecnicologo = response.data.tecnicologo;
                    resolve(this.entity);
                })
                    .catch((response: any) => {
