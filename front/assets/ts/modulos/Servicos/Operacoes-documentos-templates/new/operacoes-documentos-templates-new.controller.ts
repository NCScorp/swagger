...
export class OperacoesDocumentosTemplatesNewController {
    static $inject = [
        'utilService',
        '$scope',
        '$stateParams',
    ...
    constructor(
        ...
        $scope.$on('operacoesdocumentostemplates_submitted', (event: any, args: any) => {
            this.toaster.pop({
                type: 'success',
                title: 'O relacionamento entre a Operação e o Template foi realizado com sucesso!'
            });
            ...
            if (args.response.status === 409) {
                ...
                if (typeof (args.response.data.message) !== 'undefined' && args.response.data.message) {
                    ...
                    this.toaster.pop(
                        {
                            type: 'error',
                            title: 'Ocorreu um erro ao inserir Operacoesdocumentostemplates!'
                        });
                }
            }
