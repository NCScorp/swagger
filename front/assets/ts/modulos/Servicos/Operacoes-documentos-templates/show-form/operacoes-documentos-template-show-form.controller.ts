...
export class OperacoesDocumentosTemplatesShowFormController {

    static $inject = ['$scope', 'toaster', 'operacoesDocumentosTemplatesService', 'utilService'];
    ...
    submit() {
        ...
        if (this.form.$valid && !this.entity.$$__submitting) {
            return new Promise((resolve) => {
                this.operacoesDocumentosTemplatesService._save(this.entity).then((response: any) => {
                    this.entity.operacaodocumentotemplate = response.data.operacaodocumentotemplate;
                    resolve(this.entity);
                })
                    .catch((response: any) => {
