...
export class GpFuncoesDefaultController {
    ...
    public tooltipFuncaoCoringa: string = 'Com esta opção marcada, ao selecionar esta função no pedido e/ou orçamento, será solicitada a sua descrição';
