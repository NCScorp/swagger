...
export class FinancasContasfornecedoresDefaultController {

    static $inject = [ '$scope', 'toaster', 'FinancasContasfornecedores', 'utilService'];
    ...
    $onInit() {
        ...
        return new Promise((resolve) => {
                this.entityService._save(this.entity).then((response: any) => {
                    this.entity.contafornecedor = response.data.contafornecedor;
                    resolve(this.entity);
                })
                .catch((response: any) => {
